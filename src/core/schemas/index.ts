...
const SUPERVISED_TRANSITIONS: Record<SupervisedTaskState, SupervisedTaskState[]> = {
  ...
  RUNNING: ['AWAITING_NATIVE_RESULT', 'SUSPECT', 'CANCELLING', 'SUCCEEDED', 'FAILED', 'ORPHANED'],
  AWAITING_NATIVE_RESULT: ['STARTING', 'CANCELLING', 'FAILED', 'ORPHANED'],
  SUSPECT: ['RUNNING', 'AWAITING_NATIVE_RESULT', 'CANCELLING', 'SUCCEEDED', 'FAILED', 'ORPHANED'],

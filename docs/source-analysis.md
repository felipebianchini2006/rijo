...
| Blast-radius routing (one-shot vs full loop) | `bmad-quick-dev/workflow.md` | right-size ceremony to risk | low | heuristic | **Adopt**: `$rijo fix` versus `$rijo next`, with explicit escalation criteria |
